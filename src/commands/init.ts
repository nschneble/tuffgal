...
export default defineConfig({
  paths: {
    ...
    // Per-machine, gitignored cache for local (advisory) mode — self-diff
    // against your last accepted local state. Defaults to 'tuffgal/.cache'.
    // localCache: 'tuffgal/.cache',
  },
 ...
 *   - tuffgal/.gitignore       (ignores .auth/, .cache/, and report/)
 *
